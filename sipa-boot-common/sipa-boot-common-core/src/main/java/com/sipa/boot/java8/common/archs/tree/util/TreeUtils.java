package com.sipa.boot.java8.common.archs.tree.util;
...
public class TreeUtils {
    ...
    public static boolean isRoot(TreeNodeDetail detail) {
        ...
        return Objects.nonNull(detail) && SipaBootCommonConstants.ACROSS.equals(StringUtils.trim(detail.getParentId()));
    }
}
