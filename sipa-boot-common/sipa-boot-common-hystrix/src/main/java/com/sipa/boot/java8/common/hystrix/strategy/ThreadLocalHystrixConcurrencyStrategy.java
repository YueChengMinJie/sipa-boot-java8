package com.sipa.boot.java8.common.hystrix.strategy;
...
import com.sipa.boot.java8.common.hystrix.executor.ThreadLocalThreadPoolExecutor;
        ...
        if (!PlatformSpecific.isAppEngineStandardEnvironment()) {
            return new ThreadFactory() {
                ...
                public Thread newThread(Runnable r) {
                    Thread thread =
                        new Thread(r, "hystrix-" + threadPoolKey.name() + "-" + threadNumber.incrementAndGet());
