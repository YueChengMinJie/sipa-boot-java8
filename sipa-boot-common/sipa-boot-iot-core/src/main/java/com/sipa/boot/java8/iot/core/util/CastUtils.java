...
public class CastUtils {
    ...
    public static Number castNumber(Object value, Function<Integer, Number> integerMapper,
        Function<Long, Number> longMapper, Function<Double, Number> doubleMapper, Function<Float, Number> floatMapper,
    ...
    public static Date castDate(Object value) {
        if (value instanceof String) {
            if (StringUtils.isNumber(value)) {
                ...
                Date date = IDateFormatter.fromString(maybeTimeValue);
                if (null != date) {
                    return date;
                }
            }
