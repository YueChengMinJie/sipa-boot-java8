 ...
 * @date 2021/10/29
 */
public interface TypeMismatchExceptionAdviceTrait extends ExceptionAdviceTrait {
    /**
        ...
        return handle(request, response,
            ResponseEntity.status(HttpStatus.BAD_REQUEST)
                ...
                .body(new ErrorEntity(DEFAULT_BAD_REQUEST_EXCEPTION_NUMERIC_ERROR_CODE,
                    DEFAULT_BAD_REQUEST_EXCEPTION_ERROR_CODE, "Illegal value:" + exception.getValue().toString())));
    }
}
