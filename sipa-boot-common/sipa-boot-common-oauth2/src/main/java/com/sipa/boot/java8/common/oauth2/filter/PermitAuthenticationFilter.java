package com.sipa.boot.java8.common.oauth2.filter;
 ...
 * @date 2019-02-03
 */
public class PermitAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    public PermitAuthenticationFilter(String defaultFilterProcessesUrl) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        AnonyAuthenticationToken token = new AnonyAuthenticationToken(
